...
requires std::same_as<typename std::iterator_traits<IterT>::value_type, typename CacheKeyType<CacheT>::type>
int countCacheHits(CacheT &cache, const IterT beginIt, const IterT endIt, F slowGetPage) {
    int result = 0;
